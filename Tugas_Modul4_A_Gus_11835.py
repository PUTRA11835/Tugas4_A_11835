...
st.set_page_config(
    page_title="11835 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align: center;'>Unsupervised Learning - Gusput</h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

model_directory = r'D:\Semester 5\Kuliah\ML\Praktikum\unsuperpais\Unsupervised Learning (Praktek)\Tugas4_A_11835'
model_path = {
